...
namespace CTFAK.MMFParser.Translation
{
    public static class ShaderGenerator
    {
        public static void CreateAndDumpShader(Shader shader)
        {
            ...
            var fxPath = $"{Settings.DumpPath}\\Shaders\\{shaderName}\\{shader.Name}";
            var xmlPath = $"{Settings.DumpPath}\\Shaders\\{shaderName}\\{shaderName}.xml";
            Directory.CreateDirectory($"{Settings.DumpPath}\\Shaders\\{shaderName}");
