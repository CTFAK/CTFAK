...
public class ACT_PLAYLOOPMUSICFILE extends CAct
{
	...
	int nLoop=rhPtr.get_EventExpressionInt((CParamExpression)evtParams[1]);
	rhPtr.rhApp.musicPlayer.play(filename, nLoop);
    }
}
