...
public class CND_EXTCMPVARDBL extends CCnd
{
	CValue valueZero = new CValue(0);
	...
	public boolean eva2(CRun rhPtr)
	{
		...
		double value2=p.tokens[0].getDouble();
		if ( num >= 0 )
		{
			do {
				if (pHo.rov!=null)
				{
					...
					if (CRun.compareToDouble(value1, value2, p.comparaison)==false)
					{
						cpt--;
