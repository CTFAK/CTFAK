...
public class EXP_EXTGETMASS extends CExpOi
{
   public void evaluate(CRun rhPtr)
   {
       ...
       {
           rhPtr.rh4Results[rhPtr.rh4PosPile].forceDouble(((CMoveExtension)pHo.rom.rmMovement).callMovement(CExp.NEXP_EXTGETMASS, 0));
           return;
       }
