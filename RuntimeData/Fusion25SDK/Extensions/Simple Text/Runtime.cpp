...
*/
	...
	rdPtr->pText = (LPTSTR)malloc((_tcslen(edPtr->sText)+1)*sizeof(TCHAR));
	_tcscpy(rdPtr->pText, edPtr->sText);
...
short WINAPI DLLExport DisplayRunObject(LPRDATA rdPtr)
{
	...
	if ( ps != NULL && rdPtr->pText != NULL )
	{
		...
		ps->DrawText(rdPtr->pText, _tcslen(rdPtr->pText), &rc, dwDTFlags, rdPtr->textColor, rdPtr->hFont,
